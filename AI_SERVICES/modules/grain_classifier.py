...
class GrainClassifier:
    ...
    def _load_model(self) -> None:
        """Nạp model với lazy import Keras 3 (Torch Backend) hoặc TensorFlow fallback."""
        import os
        ...
        try:
            ...
            print(f"📦 Đang nạp mô hình CNN từ: {self.model_path} (Keras 3)...")
            ...
            try:
                ...
                print(f"📦 Đang nạp mô hình CNN từ: {self.model_path} (TensorFlow)...")
                ...
                raise RuntimeError(f"Không thể nạp mô hình CNN bằng cả Keras 3 ({exc}) và TensorFlow ({e_tf})") from exc
