...
Mục đích:
  - Khai báo tập trung danh sách, thứ tự, đơn vị và ràng buộc miền giá trị
    của 31 đặc trưng dùng trong mô hình Extra Trees Regressor.
  - Cung cấp hàm validate vector đặc trưng trước khi đưa vào model.
  - Tất cả module khác (regression_engine, app, tests) import từ đây,
    không tự khai báo danh sách features riêng.
===============================================================================
"""
